...
mkdir -p ./libraries/StepMotorMM_0/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/submodules/niosLab2_onchip_memory2_1.hex ./
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/niosLab2_onchip_memory2_1.vhd"                                   -work onchip_memory2_1                             -cdslib ./cds_libs/onchip_memory2_1.cds.lib                            
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/StepMotorMM.vhd"                                                 -work StepMotorMM_0                                -cdslib ./cds_libs/StepMotorMM_0.cds.lib                               
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/stepmotor.vhd"                                                   -work StepMotorMM_0                                -cdslib ./cds_libs/StepMotorMM_0.cds.lib                               
